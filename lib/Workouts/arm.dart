      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            ...
            const Text('ARM WORKOUT',style: TextStyle(fontFamily: 'Mrs. Monster',fontSize: 40,color: Colors.white),),
            Container(height: 5,),
            Container(
              width: 365,
              height: 400,
              child: ListView(
                children: [
                  ...
                  Container(
                    ...
                    child: const Center(
                      child: Text(
                        'Name: Hammer Curl  Sets: 3  Rep: 20',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                        ),
